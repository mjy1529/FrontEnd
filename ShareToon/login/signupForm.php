		...
		<div id="content" style="padding-left: 20px;">
			...
			<form name="signup_form" method="post" action="signup.php">
				<table cellpadding="8" align="center" width="700px">
					<tr>
						<td>* 아이디</td><td><input type="text" name="id"/>&nbsp;&nbsp;<button type="button" onclick="check_id();">중복확인</button></td>
					</tr>
					<tr>
					...
					<tr>
						<td>* 비밀번호 확인</td><td><input type="password" name="confirm_password"/></td>
					</tr>
					<tr>
						<td>* 이메일</td><td><input type="text" name="email1"/> @ <input type="text" name="email2"/></td>
					</tr>
					<tr>
						<td>* 휴대폰 번호</td>
						<td>010 -
