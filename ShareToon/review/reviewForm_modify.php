...
<html>
	...
	<body>
		...
		<div id="content">
			...
			<form name="review_form" method="post" action="modifyReview.php?idx=<?=$idx?>">
				<table cellpadding="8" border="1px" align="center" width="850px">
					<tr>
						<td align="center">제목</td><td colspan="3"><input type="text" name="title" size="50" value="<?=$title?>"/></td>
					</tr>
					<tr>
						<td align="center">작성자</td><td colspan="3"><?= $userid ?></td>
					</tr>
					<tr>
						<td align="center">관련 웹툰 제목</td><td><input type="text" name="referencedToon" size="40" value="<?=$referencedToon?>"/></td>
					...
					<tr>
						...
						<td colspan="3"><textarea cols="100" rows="17" name="content"><?=$content?></textarea></td>
					</tr>
				<table>
				<button type="button" style="margin-top: 10px; margin-right: 75px; float: right;"
						onclick="check_input()">수정</button>
